...
const namePrefix = "THE BOHO CLAN";
const description = "These creatures have abilities, they have powers beyond imagination, they've existed right from the beginning of time, and have witnessed it all.";
...
const LIMIT = .01; // Your API key rate limit
const CHAIN = 'rinkeby'; // only rinkeby, polygon, or ethereum

// REQUIRED CONTRACT DETAILS THAT CANNOT BE UPDATED LATER!
const CONTRACT_NAME = 'THE BOHO CLAN';
const CONTRACT_SYMBOL = 'TBC';
const METADATA_UPDATABLE = false; // set to false if you don't want to allow metadata updates after minting
const OWNER_ADDRESS = '0x7DF81C6358EC707cc8D88c7B479D6148beF5c85a';
const TREASURY_ADDRESS = '0x7DF81C6358EC707cc8D88c7B479D6148beF5c85a';
